    ...
    "{                                                                                                                                                                  \n"
        ...
        "    gl_FragColor             = (    texture2D(Texture1,  varTexcoord.xy) * mix(exp2((1.0-NdotL1_DIFFUSE)* -1.0)  ,  NdotL1_DIFFUSE , 0.7)                      \n"
    


        "                             + (texture2D(Texture1,  varTexcoord.xy).y * 0.4 * highp vec4(max(pow(NdotL1_SPEC, 50.0), 0.0)))      ) ;                                 \n"
